...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ComplantSystem.Models.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "4602abc2-36e8-4e12-b70b-ad040138cea1",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "a824b195-d93c-4cf6-b899-caed79b2ef5a",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "8a2631e9-5220-44df-8dc1-41049bd0862b",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "5641b76d-7792-45aa-bbf0-02a5ce2d57b3",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "b079a149-9a51-449f-9b6d-f2e90522e9bb",
                            Name = "AdminVillages",
            ...
            modelBuilder.Entity("ComplantSystem.Models.Compalints_Solution", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ComplantSystem.Models.TypeComplaint", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "f05f0e9a-faff-4908-b387-d58b348957be",
                            CreatedDate = new DateTime(2022, 8, 10, 21, 13, 40, 868, DateTimeKind.Local).AddTicks(5188),
                            Type = "زراعية"
                        },
                        new
                        {
                            Id = "6a0da0fe-1094-47fc-94da-1ad0def26eb0",
                            CreatedDate = new DateTime(2022, 8, 10, 21, 13, 40, 868, DateTimeKind.Local).AddTicks(6029),
                            Type = "فساد"
                        },
                        new
                        {
                            Id = "92707573-32dd-4c0c-96ad-0dac793fe68e",
                            CreatedDate = new DateTime(2022, 8, 10, 21, 13, 40, 868, DateTimeKind.Local).AddTicks(6062),
                            Type = "مماطلة"
                        },
                        new
                        {
                            Id = "1c90cf0a-cf32-4bce-b690-403a124a41f5",
                            CreatedDate = new DateTime(2022, 8, 10, 21, 13, 40, 868, DateTimeKind.Local).AddTicks(6074),
                            Type = "إرتشاء"
                        });
                });
            ...
            modelBuilder.Entity("ComplantSystem.UploadsComplainte", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ComplantSystem.Models.Compalints_Solution", b =>
                {
                    ...
                    b.HasOne("ComplantSystem.Models.Compalint", "CompalintsHasSolution")
                        .WithMany("Compalints_Solutions")
                        .HasForeignKey("CompalintsHasSolutionId");

                    b.HasOne("ComplantSystem.UploadsComplainte", null)
                        .WithMany("Compalints_Solutions")
            ...
            modelBuilder.Entity("ComplantSystem.Models.ApplicationRoleClaim", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", null)
                        .WithOne()
                        .HasForeignKey("ComplantSystem.Models.ApplicationRoleClaim", "Id")
            ...
            modelBuilder.Entity("ComplantSystem.Models.ApplicationUserClaim", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", null)
                        .WithOne()
                        .HasForeignKey("ComplantSystem.Models.ApplicationUserClaim", "Id")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ComplantSystem.Models.ApplicationUserLogin", b =>
                {
                    ...
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUserLogin<string>", null)
                        .WithOne()
                        .HasForeignKey("ComplantSystem.Models.ApplicationUserLogin", "LoginProvider", "ProviderKey")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ComplantSystem.Models.ApplicationUserRole", b =>
                {
                    ...
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", null)
                        .WithOne()
                        .HasForeignKey("ComplantSystem.Models.ApplicationUserRole", "UserId", "RoleId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ComplantSystem.Models.ApplicationUserToken", b =>
                {
                    ...
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUserToken<string>", null)
                        .WithOne()
                        .HasForeignKey("ComplantSystem.Models.ApplicationUserToken", "UserId", "LoginProvider", "Name")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
