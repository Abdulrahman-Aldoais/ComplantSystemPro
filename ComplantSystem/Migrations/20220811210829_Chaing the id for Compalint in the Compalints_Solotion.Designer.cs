...
namespace ComplantSystem.Migrations
{
    ...
    [Migration("20220811210829_Chaing the id for Compalint in the Compalints_Solotion")]
    partial class ChaingtheidforCompalintintheCompalints_Solotion
    {
            ...
            modelBuilder.Entity("ComplantSystem.Models.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "f0d4f427-9faa-453f-8b75-9056ab6dcfab",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "bfd93fc6-ec9d-44e1-b300-9d7fbe51b145",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "f3eed1fa-80ec-4f61-a096-f9c5a75df10a",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "5cebea18-5120-474b-ae24-68691534474a",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "9617b8ec-35ff-4cff-97ae-a259a0f4de23",
                            Name = "AdminVillages",
            ...
            modelBuilder.Entity("ComplantSystem.Models.TypeComplaint", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "59ea2b07-ce28-4e65-b9ee-49ca010c80d9",
                            CreatedDate = new DateTime(2022, 8, 12, 0, 8, 28, 0, DateTimeKind.Local).AddTicks(958),
                            Type = "زراعية"
                        },
                        new
                        {
                            Id = "7df4b063-e41d-46ea-84f5-d6bcda26ac19",
                            CreatedDate = new DateTime(2022, 8, 12, 0, 8, 28, 0, DateTimeKind.Local).AddTicks(1915),
                            Type = "فساد"
                        },
                        new
                        {
                            Id = "9b57793c-fc7c-48b1-90fe-4cca1f86a663",
                            CreatedDate = new DateTime(2022, 8, 12, 0, 8, 28, 0, DateTimeKind.Local).AddTicks(1930),
                            Type = "مماطلة"
                        },
                        new
                        {
                            Id = "61680aac-208a-4ae6-90b2-8fe09449c072",
                            CreatedDate = new DateTime(2022, 8, 12, 0, 8, 28, 0, DateTimeKind.Local).AddTicks(2216),
                            Type = "إرتشاء"
                        });
                });
