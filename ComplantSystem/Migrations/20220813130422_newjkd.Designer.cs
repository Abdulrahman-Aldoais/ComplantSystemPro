...
namespace ComplantSystem.Migrations
{
    ...
    [Migration("20220813130422_newjkd")]
    partial class newjkd
    {
            ...
            modelBuilder.Entity("ComplantSystem.Models.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "ea5b878b-f17c-474f-869a-38fd6694ddc5",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "03306345-9c7d-4973-98ac-b6307522cfc3",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "f5cf30d1-4e96-44b1-a0a5-5e43ddcca421",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "53cdcaa0-886f-4264-bb7e-3acb74f1ae2e",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "d475397d-6acc-40ac-94e9-ebac6b4be4a7",
                            Name = "AdminVillages",
            ...
            modelBuilder.Entity("ComplantSystem.Models.TypeComplaint", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "c25a3650-0a80-4385-aae9-f9eddf0e0117",
                            CreatedDate = new DateTime(2022, 8, 13, 16, 4, 19, 909, DateTimeKind.Local).AddTicks(3321),
                            Type = "زراعية"
                        },
                        new
                        {
                            Id = "8dfd7949-b4f9-46b0-93b2-526078d3fc11",
                            CreatedDate = new DateTime(2022, 8, 13, 16, 4, 19, 909, DateTimeKind.Local).AddTicks(4241),
                            Type = "فساد"
                        },
                        new
                        {
                            Id = "5f4a51bc-c568-4747-b01e-873662c656a9",
                            CreatedDate = new DateTime(2022, 8, 13, 16, 4, 19, 909, DateTimeKind.Local).AddTicks(4254),
                            Type = "مماطلة"
                        },
                        new
                        {
                            Id = "6ff254c3-8093-4eb5-981e-641cb2fb1e11",
                            CreatedDate = new DateTime(2022, 8, 13, 16, 4, 19, 909, DateTimeKind.Local).AddTicks(4266),
                            Type = "إرتشاء"
                        });
                });
