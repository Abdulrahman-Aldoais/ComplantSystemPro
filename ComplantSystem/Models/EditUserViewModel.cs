...
namespace ComplantSystem
{
    public class EditUserViewModel
    {
        ...
        [Required(ErrorMessage = "ادخل رقم البطاقة"), MaxLength(9, ErrorMessage = "يجب ان لا يكون رقم البطاقة اكبر من تسعة 12 رقم "), MinLength(9, ErrorMessage = "يجب ان لا يكون رقم الهاتف اقل من تسعة ارقام")]
